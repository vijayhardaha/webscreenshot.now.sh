...
export const defaultScreen = getResolution("desktop");
...
export const defaultData = {
  ...
  url: "",
  valid: true,
  width: defaultScreen.w,
};

export const screenOptions = screens.map(
  (group) => (
    (group.options = group.options.map(
      (o) => ((o.label = `${o.label} (${o.w}x${o.h})`), o)
    )),
    group
  )
);
